...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cxhq5cc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cxhq5cc.containers.anotherwebservice.com/
...
```
git clone git@github.com:MahirShah07/container-cxhq5cc.git
cd container-cxhq5cc
```
...
```
docker attach container-cxhq5cc
```
